...
const SnippetCard = ({
  ...
  return (
    <motion.article
      ...
      className="group w-full rounded-xl overflow-hidden bg-[#161215] border border-[#2E232C] shadow-md hover:border-[#C562AF]/60 hover:shadow-xl transition-all duration-300 flex flex-col h-full p-5 sm:p-6 justify-between"
    >
      <div className="flex-1 flex flex-col">
        ...
        <div
          ...
          className="relative rounded-lg bg-zinc-900 border border-[#2E232C] overflow-hidden shadow-inner mt-auto mb-1"
        >
      ...
      <footer
        ...
        className="mt-auto pt-4 border-t border-[#2E232C] flex flex-row items-center gap-2"
      >
